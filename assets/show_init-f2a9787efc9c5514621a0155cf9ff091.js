(function() {
    ...
    e = $.noConflict(!0), window.$ || (window.$ = window.jQuery = e), $(function() {
        var e;
        if ($B.isStatic() || "undefined" != typeof data) return e = new $B.SocialMediaConfig({
        ...
        }), window.social_media_config = e, window.slide_navigator = new $B.Navigator(), 
        ...
        window.edit_page.initAfterBindings()), window.slide_navigator.init(), $S.conf.preview_mode || $B.isHeadlessRendering() || $S.conf.is_screenshot_rendering || ($B.PageAE = new $B.PageAnalyticsEngine({
            ...
            strkGaTracker: $S.page_meta.strk_ga_tracker,
            googleAnalyticsTracker: $S.page_meta.google_analytics_tracker,
            googleAnalyticsType: $S.page_meta.google_analytics_type
        }), $B.PageAE.logPageView(), $B.PageAE.trackPageEvent(), $B.PageAE.setSocialShareTracking(), 
        $B.isStatic()) ? void 0 : $B.PageAE.setInternalTracking();
    });
}).call(this);
