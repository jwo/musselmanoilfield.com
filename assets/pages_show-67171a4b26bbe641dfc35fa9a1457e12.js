...
!function(e, t) {
    ...
    M = function(e) {
        return "string" == typeof e || "object" == typeof e && (p ? x(e) : h.call(e) === L);
    };
    var S = function(e) {
    ...
    D(Object, {
        keys: function(e) {
            var n = t(e), o = S(e), i = null !== e && "object" == typeof e, r = i && M(e);
    ...
    e.fn.ajaxSubmit = function(n) {
        function o(o) {
                ...
                if (!f.aborted && !S) {
                    ...
                    if (L && L.location.href != d.iframeSrc || y) {
                        ...
                        try {
                            ...
                            var a = L.body ? L.body : L.documentElement;
                            f.responseText = a ? a.innerHTML : null, f.responseXML = L.XMLDocument ? L.XMLDocument : L, 
                            ...
                            if (c || d.textarea) {
                                ...
                                f.statusText = g.getAttribute("statusText") || f.statusText; else if (c) {
                                    var _ = L.getElementsByTagName("pre")[0], w = L.getElementsByTagName("body")[0];
                        ...
                        d.complete && d.complete.call(d.context, f, i), S = !0, d.timeout && clearTimeout(v), 
                        setTimeout(function() {
            ...
            if (!f.aborted) {
                ...
                var x, L, S, D = 50, Y = e.parseXML || function(e, t) {
    ...
    t.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            var n = this.tip();
            if (this.setContent(), this.options.width) {
                var o = this.tip().find(".tooltip-inner");
                o.css({
                    "max-width": this.options.width
                });
            }
            this.options.animation && n.addClass("fade");
            var i = "function" == typeof this.options.placement ? this.options.placement.call(this, n[0], this.$element[0]) : this.options.placement, r = /\s?auto?\s?/i, s = r.test(i);
            s && (i = i.replace(r, "") || "top"), n.detach().css({
                top: 0,
                left: 0,
                display: "block"
            }).addClass(i), this.options.container ? n.appendTo(this.options.container) : n.insertAfter(this.$element);
            var a = this.getPosition(), l = n[0].offsetWidth, u = n[0].offsetHeight;
            if (s) {
                var c = this.$element.parent(), d = i, h = document.documentElement.scrollTop || document.body.scrollTop, g = "body" == this.options.container ? window.innerWidth : c.outerWidth(), p = "body" == this.options.container ? window.innerHeight : c.outerHeight(), m = "body" == this.options.container ? 0 : c.offset().left;
                i = "bottom" == i && a.top + a.height + u - h > p ? "top" : "top" == i && a.top - h - u < 0 ? "bottom" : "right" == i && a.right + l > g ? "left" : "left" == i && a.left - l < m ? "right" : i, 
                n.removeClass(d).addClass(i);
            }
            var f = this.getCalculatedOffset(i, a, l, u);
    ...
    function z(e) {
        ...
        for (o = O(e._f, s).match(Se) || [], t = 0; t < o.length; t++) i = o[t], n = (a.match(H(i, e)) || [])[0], 
    ...
    for (nt.DDDD = o(nt.DDD, 3), l(r.prototype, {
        ...
        r = {
            ...
            s: y(s[ye]) * n,
            ms: y(s[ve]) * n
        }) : (s = Le.exec(e)) && (n = "-" === s[1] ? -1 : 1, i = function(e) {
    ...
    le.lang = function(e, t) {
        var n;
        return e ? (t ? D(L(e), t) : null === t ? (Y(e), e = "en") : be[e] || $(e), n = le.duration.fn._lang = le.fn._lang = $(e), 
    ...
    le.normalizeUnits = function(e) {
        ...
        diff: function(e, t, n) {
            var o, i, r = S(e, this), s = 6e4 * (this.zone() - r.zone());
        ...
        calendar: function() {
            var e = S(le(), this).startOf("day"), t = this.diff(e, "days", !0), n = -6 > t ? "sameElse" : -1 > t ? "lastWeek" : 0 > t ? "lastDay" : 1 > t ? "sameDay" : 2 > t ? "nextDay" : 7 > t ? "nextWeek" : "sameElse";
    ...
    !function(t) {
        ...
        !function(e) {
            ...
            m.extenders.trackArrayChanges = function(e) {
                ...
                function r(e, t) {
                    S[t] || (S[t] = e.subscribe(l), ++D);
                }
                function s() {
                    m.utils.objectForEach(S, function(e, t) {
                        t.dispose();
                    }), S = {};
                }
                function a() {
                ...
                function u(n) {
                    if (f) {
                        ...
                        if (f = !0, b) try {
                            ...
                            m.dependencyDetection.begin({
                                callback: function(e, t) {
                                    w || (a && s[t] ? (S[t] = s[t], ++D, delete s[t], --a) : r(e, t));
                                },
                                computed: c,
                                isInitial: v ? t : !D
                            }), S = {}, D = 0;
                ...
                var k = i.write, M = i.disposeWhenNodeIsRemoved || i.disposeWhenNodeIsRemoved || null, T = i.disposeWhen || i.disposeWhen, x = T, L = a, S = {}, D = 0, Y = null;
                ...
                })), b || i.deferEvaluation || u(), M && h() && M.nodeType && (L = function() {
                    m.utils.domNodeDisposal.removeDisposeCallback(M, L), a();
            ...
            m.bindingHandlers.options = {
                ...
                update: function(e, n, o) {
                    ...
                    function s(n, i, s) {
                        ...
                        if (n === L) m.utils.setTextContent(a, o.get("optionsCaption")), m.selectExtensions.writeValue(a, t); else {
                    ...
                    o.has("optionsAfterRender") && (w = function(e, n) {
                        a(e, n), m.dependencyDetection.ignore(o.get("optionsAfterRender"), null, [ n[0], e !== L ? e : t ]);
            ...
            m.utils.findMovesInArrayComparison = function(e, t, n) {
                ...
                m.utils.setDomNodeChildrenFromArrayMapping = function(o, i, r, s, a) {
                    ...
                    for (var c, d, h, g = m.utils.domData.get(o, n) === t, p = m.utils.domData.get(o, n) || [], f = m.utils.arrayMap(p, function(e) {
                        return e.arrayEntry;
                    }), _ = m.utils.compareArrays(f, i, s.dontLimitMoves), w = [], y = 0, v = 0, b = [], k = [], M = [], T = [], x = [], L = 0; d = _[L]; L++) switch (h = d.moved, 
                    d.status) {
                      case "deleted":
                        h === t && (c = p[y], c.dependentObservable && c.dependentObservable.dispose(), 
                        b.push.apply(b, m.utils.fixUpContinuousNodeArray(c.mappedNodes, o)), s.beforeRemove && (M[L] = c, 
                        k.push(c))), y++;
                        break;
                      ...
                      case "added":
                        ...
                        }, w.push(c), k.push(c), g || (x[L] = c));
                    }
                    u(s.beforeMove, T), m.utils.arrayForEach(b, s.beforeRemove ? m.cleanNode : m.removeNode);
                    for (var S, D, L = 0, Y = m.virtualElements.firstChild(o); c = k[L]; L++) {
                        c.mappedNodes || m.utils.extend(c, e(o, r, c.arrayEntry, a, c.indexObservable));
                        for (var $ = 0; D = c.mappedNodes[$]; Y = D.nextSibling, S = D, $++) D !== Y && m.virtualElements.insertAfter(o, D, S);
    ...
    function r(e, t) {
        ...
        n.copy = s(t.copy, n.copy), n.observe = s(t.observe, n.observe)), n.ignore = s(n.ignore, S.ignore), 
        n.include = s(n.include, S.include), n.copy = s(n.copy, S.copy), n.observe = s(n.observe, S.observe), 
    ...
    function l(n, o, r, s, c, m, f) {
        ...
        if (s = s || "", _) {
            ...
            if (L() && (n = S(n)), y.save(o, n), L()) return n;
            g(o, function(t) {
          ...
          case "function":
            L() ? e.isWriteableObservable(o) ? (o(S(o)), n = o) : n = S(o) : n = o;
            break;
          ...
          default:
            ...
            var K = M() || L();
            if (n = M() ? T() : e.observable(e.utils.unwrapObservable(o)), L() && n(S(n)), K) return n;
        }
        return n;
    }
    function u(e, t, n) {
    ...
    var w, y, v = !0, b = "__ko_mapping__", k = e.dependentObservable, M = 0, T = [ "create", "update", "key", "arrayChanged" ], x = {}, L = {
        include: [ "_destroy" ],
        ignore: [],
        copy: [],
        observe: []
    ...
    t.isMapped = function(t) {
        ...
        return arguments.length > 0 ? void (S = arguments[0]) : S;
    ...
    M.bind = function(e, t) {
        ...
        return o = a.call(arguments, 2), n = function() {
            ...
            var i = new L(), r = e.apply(i, o.concat(a.call(arguments)));
    ...
    n.extend(a, {
        ...
        _setDimension: function() {
            var e, t, o, i, r, s, l, u, c, d, h, p, _, w, y, v = a.getViewport(), b = 0, k = !1, M = !1, T = a.wrap, x = a.skin, L = a.inner, S = a.current, D = S.width, Y = S.height, $ = S.minWidth, E = S.minHeight, C = S.maxWidth, I = S.maxHeight, O = S.scrolling, H = S.scrollOutside ? S.scrollbarWidth : 0, B = S.margin, j = m(B[1] + B[3]), A = m(B[0] + B[2]);
            if (T.add(x).add(L).width("auto").height("auto").removeClass("fancybox-tmp"), e = m(x.outerWidth(!0) - x.width()), 
            t = m(x.outerHeight(!0) - x.height()), o = j + e, i = A + t, r = g(D) ? (v.w - o) * m(D) / 100 : D, 
            s = g(Y) ? (v.h - i) * m(Y) / 100 : Y, "iframe" === S.type) {
                if (w = S.content, S.autoHeight && 1 === w.data("ready")) try {
                    w[0].contentWindow.document.location && (L.width(r).height(9999), y = w.contents().find("body"), 
                    H && y.css("overflow-x", "hidden"), s = y.outerHeight(!0));
                } catch (e) {}
            } else (S.autoWidth || S.autoHeight) && (L.addClass("fancybox-tmp"), S.autoWidth || L.width(r), 
            S.autoHeight || L.height(s), S.autoWidth && (r = L.width()), S.autoHeight && (s = L.height()), 
            L.removeClass("fancybox-tmp"));
            if (D = m(r), Y = m(s), c = r / s, $ = m(g($) ? m($, "w") - o : $), C = m(g(C) ? m(C, "w") - o : C), 
            E = m(g(E) ? m(E, "h") - i : E), I = m(g(I) ? m(I, "h") - i : I), l = C, u = I, 
            S.fitToView && (C = Math.min(v.w - o, C), I = Math.min(v.h - i, I)), p = v.w - j, 
            _ = v.h - A, S.aspectRatio ? (D > C && (D = C, Y = m(D / c)), Y > I && (Y = I, D = m(Y * c)), 
            D < $ && (D = $, Y = m(D / c)), Y < E && (Y = E, D = m(Y * c))) : (D = Math.max($, Math.min(D, C)), 
            S.autoHeight && "iframe" !== S.type && (L.width(D), Y = L.height()), Y = Math.max(E, Math.min(Y, I))), 
            S.fitToView) if (L.width(D).height(Y), T.width(D + e), d = T.width(), h = T.height(), 
            S.aspectRatio) for (;(d > p || h > _) && D > $ && Y > E && !(b++ > 19); ) Y = Math.max(E, Math.min(I, Y - 10)), 
            D = m(Y * c), D < $ && (D = $, Y = m(D / c)), D > C && (D = C, Y = m(D / c)), L.width(D).height(Y), 
            T.width(D + e), d = T.width(), h = T.height(); else D = Math.max($, Math.min(D, D - (d - p))), 
            Y = Math.max(E, Math.min(Y, Y - (h - _)));
            H && "auto" === O && Y < s && D + e + H < p && (D += H), L.width(D).height(Y), T.width(D + e), 
            d = T.width(), h = T.height(), k = (d > p || h > _) && D > $ && Y > E, M = S.aspectRatio ? D < l && Y < u && D < r && Y < s : (D < l || Y < u) && (D < r || Y < s), 
            n.extend(S, {
                dim: {
                    width: f(d),
                    height: f(h)
            ...
            }), !w && S.autoHeight && Y > E && Y < I && !M && L.height("auto");
        },
    ...
    window.$B = window.Bobcat = window.$B || {}, $B.TH = $B.TH || {}, $B.TH.Core = {
        ...
        applyTouchNav: function() {
            ...
            })), $B.TH.Util.canAnimateCSS() && $(".navbar-drawer, .navbar-drawer-bar, .mobile-actions").addClass("strikingly-nav-transition"), 
